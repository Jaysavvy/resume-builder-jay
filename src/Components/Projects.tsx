    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Events App</h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Built events app backend using the Nest.js framework. The app's backend contained routing and controllers, using databases including TypeORM for data persistence with Repository, Query Builder, and Relations</p>
                <a href="https://github.com/Jaysavvy/nest-events-backend" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
                </a>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Icon Generator</h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Developed a robust full-stack application using TypeScript, Next.js,DALL-E API. Includes stripe payment integration and credit system</p>
                <a href="https://github.com/Jaysavvy/Icon-generator-ai" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg className="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                    </svg>
                </a>
